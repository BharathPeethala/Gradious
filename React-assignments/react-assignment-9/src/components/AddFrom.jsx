...
function AddFrom({
	...
	const handleSubmit = (e) => {
		...
		// }
		// let timeValue;
		// if (FormData.visitTime === "10:00 am - 1:00 pm") {
		// 	timeValue = 10;
		// } else if (FormData.visitTime === "02:00 pm - 5:00 pm") {
		// 	timeValue = 20;
		// } else {
		// 	timeValue = 30;
		// }
		// let DateValue = Number.parseInt(
		// 	FormData.visitDate.split(",")[1].split(" ")[1].split("th")[0]
		// );
		// DateValue = DateValue < 10 ? "0" + DateValue : DateValue;
		// let MonthValue = Number.parseInt(
		// 	months[FormData.visitDate.split(",")[1].split(" ")[2]]
		// );
		// console.log(Number.parseInt("" + MonthValue + DateValue + timeValue));
		// FormData.value = Number.parseInt("" + MonthValue + DateValue + timeValue);
		if (updateIdFlag[1]) {
			let localArray = JSON.parse(localStorage.getItem("bookings"));
			localArray[updateIdFlag[0]] = FormData;
			// localArray.sort(compareValue);
